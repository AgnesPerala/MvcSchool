...
namespace School.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentId,Grade,CourseId,FkStudentId")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnrollmentId,Grade,CourseId,FkStudentId")] Enrollment enrollment)
        {
